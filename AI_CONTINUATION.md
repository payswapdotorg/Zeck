...
- VAL-003 (golden corpus) COMPLETE: PR #46 (merge ea3ac03, issue #45) — the versioned schema, 22 workload families x 440 tasks, fixture manifest, run-metadata wiring.
- VAL-004 (universal recorder) COMPLETE: PR #48 (merge 36d9045, issue #47) — trajectory vocabulary, enforced redaction, universal run records (estimate/measured cost separation), append-only revisions, export + diffing, harness absorption.
- VALIDATION LAB FOUNDATIONS COMPLETE (2026-09-12): VAL-001 (lab bootstrap, PR #42), VAL-002 (customer-style SDK harness, PR #44), VAL-003 (golden corpus, PR #46), VAL-004 (universal recorder, PR #48), VAL-009 (capability matrix + real probes, PR #49), VAL-008 (evaluation engine, PR #50), VAL-007 (experiment ledger, PR #51), VAL-005 (comparator harness + real OpenRouter baseline, PR #52), VAL-006 (accounting, PR #53). All nine lab-foundation WOs delivered with green CI at every merge.
- Capability truth (VAL-009 probes): model:text / model:vlm / model:vision READY via OpenRouter open-weights routes; OpenAI region-blocked from this environment; qwen + BytePlus/Seedance endpoints unresolved (operator confirmations requested); 3D + agent infra absent.
