# WORK-007 — Policy engine and admission boundary
...
Implement policy resolution and the mandatory pre-dispatch gate.
...
Requires: WORK-003, WORK-004, WORK-005, WORK-006
...
- implementation evidence in `docs/work-items/WORK-007.md`
...
1. Implement policy precedence across platform/application/user/task/execution scopes.
2. Express restrictions for cost, quality, latency, provider/model, tool, network, secrets, autonomy and isolation.
3. Enforce monotonic tightening: a lower authority may not weaken a higher prohibition.
4. Make provider/tool/agent/sandbox/secret dispatch impossible before a policy allow result.
5. Produce durable admission evidence identifying effective policy version/hash.
