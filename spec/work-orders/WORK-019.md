# WORK-019 — MicroVM/VM execution fleet and customer runners
...
Extend ComputeEnvironment to stronger isolation and customer-controlled execution.
...
Requires: WORK-012, WORK-016, WORK-018
...
- implementation evidence in `docs/work-items/WORK-019.md`
...
1. Implement microVM/VM adapter contracts without changing ComputeEnvironment semantics.
2. Implement runner registration, capability declaration, health and assignment lifecycle.
3. Keep customer runners tenant-isolated and explicitly authorized.
4. Preserve execution identity/provenance across remote runner handoff and reconnect.
5. Prove concurrent runner assignment converges without duplicate execution of one logical step.
