# WORK-001 — Repository, modular-monolith and governance foundation
...
Create executable project skeleton and preserve repository governance.
...
- None directly; this Work Order establishes implementation substrate/governance.
...
- implementation evidence in `docs/work-items/WORK-001.md`
...
1. Initialize strict TypeScript/Bun toolchain with deterministic install/typecheck/lint/test commands.
2. Create the module directory skeleton and public/internal boundary convention defined by IMPLEMENTATION.md.
3. Add the database, Redis, object-store, clock, crypto and secret-store ports without coupling domains to infrastructure.
4. Add architecture/dependency tests that reject cross-module internal imports and provider SDK imports outside adapters.
5. Ensure a fresh clone can run governance validation without any application source being present yet.
