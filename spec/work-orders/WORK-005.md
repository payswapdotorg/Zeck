# WORK-005 — Capability registry and capability evidence
...
Define the capability catalog that precedes provider selection.
...
- implementation evidence in `docs/work-items/WORK-005.md`
...
1. Represent model, tool, algorithm, data, runtime and human capabilities with provider-neutral metadata.
2. Allow adapters to publish capability facts and evidence without becoming the capability authority.
3. Resolve capability requirements from a task profile before any provider/model route is selected.
4. Record evidence/version information for capability claims.
5. Add a discrimination proof that rejects a plan attempting provider selection before capability resolution.
