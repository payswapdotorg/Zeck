# WORK-008 — Context compiler and artifact lineage
...
Transform application context into lineage-preserving task artifacts.
...
- implementation evidence in `docs/work-items/WORK-008.md`
...
1. Implement retrieval, relevance filtering, deduplication, compression and structural compilation as explicit stages.
2. Persist immutable artifacts with content digest, source references and parent/child lineage.
3. Bind compiled context to the execution and plan revision that consumed it.
4. Prevent cross-tenant source retrieval and artifact adoption.
5. Prove identical inputs and compiler version produce a reproducible lineage manifest.
