# WORK-017 — Advanced tool learning and tool-composition intelligence
...
Use historical evidence to improve tool composition without changing authority.
...
- implementation evidence in `docs/work-items/WORK-017.md`
...
1. Learn tool-sequence effectiveness by task class and policy context.
2. Produce ranked compositions with confidence, provenance and evaluation windows.
3. Feed compositions into planning as recommendations that remain policy-gated.
4. Prevent unsupported/cyclic compositions and unverifiable recommendations.
5. Prove rollback to a prior recommendation set without mutating historical evidence.
